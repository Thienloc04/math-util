...
class MathUtilityDDTTest {
    ...
    //hàm này trả về 1 mảng các con số < 0 hoặc > 20, đó là những n gy ra
    ...
    public void testFactorialGivenRightArgumentsReturnWell(int n, long excepted){
        assertEquals(excepted, MathUtility.getFactrial(n));
    }
